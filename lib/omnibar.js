...
module.exports = class Omnibar {
    constructor(){
        ...
        this.disposables.add(via.markets.onDidCreateMarket(this.loadDefaultItems));
        this.disposables.add(via.markets.onDidDestroyMarket(this.loadDefaultItems));
        ...
        return {
            ...
            didConfirmSelection: selection => {
                if(selection.command){
                    ...
                    via.workspace.open(`via://charts/${selection.market.exchange.id}/${selection.market.symbol}`, {});
    ...
    loadDefaultItems(){
        ...
        //Markets
        const markets = via.markets.all().map(market => {
            // const keybinding = keybindings.find(kbd => kbd.command === command.name);
            return {group: 'markets', name: market.symbol, description: market.description, market};
        });
